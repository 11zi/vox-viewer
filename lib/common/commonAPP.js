...
function modelData(_name, _author, _author_avatar_url, _description, _id) {
  ...
  this.id = _id;
  this.url = _name ? ('https://github.com/11zi/vox-viewer/blob/main/VOX-models/' + _name + '.vox') : '#';
  this.img_url = _name ? ('https://github.com/11zi/vox-viewer/blob/main/VOX-models/' + _name + '.png') : '/VOX-models/img_not_found.jpg';
